...
to create-frame
  ...
  while [x <= world-size-w] [
    ...
    while [ y < world-size-h - btn-height ] [
      ...
      if [pcolor] of patch x y = 2.9 [ ask patch x y [ set pcolor black ] ]
...
to render-animator
  ...
  [
    ...
    register-button [[] -> ( set page "MENU" )] world-size-w * -1 world-size-h - btn-height "BACK"
    register-button [[] -> ( create-frame )] world-size-w * -1 + btn-width * 1.2 world-size-h - btn-height "KEYFRAME"
    register-button [[] -> ( set draw-color 0 )] world-size-w * -1 + btn-width * 2.5 world-size-h - btn-height "ERASE"
    register-button [[] -> ( ask patches with [pycor < world-size-h - btn-height] [ set pcolor black ] )] world-size-w * -1 + btn-width * 3.7 world-size-h - btn-height "CLEAR"
    register-button [[] -> ( output-animation )] world-size-w * -1 + btn-width * 4.9 world-size-h - btn-height "GENERATE"
